...
Planned work that is not in this binary gets a developer page and a
Features **Later** bullet. It does not get an operator Help chapter until
it ships. Example: [LLM Agent API](agent-api.md).
