...
`updates_apply`, `updates_autoremove`, `net_set`, `vlan_add`, `wifi_scan`, `wifi_join`, `ssh_password`, `gitlab_backup`, `gitlab_restore`, `reboot`,
`journal`, `unit_restart`, `unit_enable`, `timezone_set`, `unattended_set`) — see
