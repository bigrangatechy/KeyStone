...
- System Manage: apt apply, apt autoremove, IPv4/IPv6 DHCP vs static, VLAN create, Wi-Fi join, SSH password, leftover/failed unit restart, Start KeyStone on boot, GitLab Omnibus backup,
